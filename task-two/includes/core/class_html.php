...
class HTML {
    ...
    //вывод html файла на страницу через буфер обмена
    ...
    //формирует путь к html файлу из директории "partials_c\%341^%3410904248^index.html%341^%3410904248^index.html"
